...
const AboutSection = ({ id }) => {
  return (
    <div
      id={id}
      className="w-full  h-[300vh] pl-10 pr-5 flex gap-10 justify-center items-center"
    >
      <div className="w-[60vw]">
        <Header
          as="h1"
          className="instrument-serif-regular text-7xl sm:text-8xl pl-10 leading-24 sm:leading-40 text-[#f8f1de]"
        >
         About Me
        </Header>
        <p className="text-[#f8f1de] font-semibold text-3xl pl-10 tracking-tighter sm:text-6xl leading-12 sm:leading-14">
       I am a passionate Computer Science student at MAIT, driven by a love for design and development. I enjoy turning ideas into seamless digital experiences and continuously honing my skills. <br />
          <br />
        </p>
      </div>
