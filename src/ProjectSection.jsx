...
const ProjectSection = ({ id }) => {
  return (
    <div id={id} className="w-full h-[190vh] flex flex-col gap-40">
      <Header
        as="h1"
        className="p-6 instrument-serif-regular text-[90px] sm:text-7xl text-center leading-20 sm:leading-45 text-[#f8f1de] "
      >
